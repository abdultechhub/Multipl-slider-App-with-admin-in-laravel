...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item nav-profile dropdown">
            <a class="nav-link" href="{{ url('admin/update-admin-details') }}" data-toggle="dropdown"
                id="profileDropdown">
                Abdul
            </a>
            <div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
                ...
                <a href="{{ url('admin/update-admin-details') }}" class="dropdown-item">
                    ...
                    {{-- <span class="text-muted float-right text-sm">12 </span> --}}
                </a>
                <div class="dropdown-divider"></div>
                <a href="{{ url('admin/logout') }}" class="dropdown-item">
                    <i class="fa-solid fa-lock mr-2"></i> Logout
                    {{-- <span class="text-muted float-right text-sm">2 days</span> --}}
                </a>
                <div class="dropdown-divider"></div>
            </div>
